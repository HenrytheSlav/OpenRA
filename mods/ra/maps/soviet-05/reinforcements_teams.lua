...
if Map.Difficulty == "Easy" then gguy2 = {"jeep", "1tnk", "1tnk"} else gguy2 = {"jeep", "jeep", "1tnk", "1tnk", "1tnk"} end
...
IslandTroops = function()
	...
	Trigger.AfterDelay(DateTime.Minutes(3), function()	
		...
		Utils.Do(units, function(unit) Trigger.OnIdle(unit, function(idk) idk.Patrol( {waypoint19.Location, waypoint29.Location, waypoint31.Location, waypoint20.Location}, true, 150) end) end) end)
	...
	Trigger.AfterDelay(DateTime.Minutes(6), function()	
		...
		Utils.Do(units, function(unit) Trigger.OnIdle(unit, function(idk) idk.AttackMove( waypoint39.Location) end) end) end)
