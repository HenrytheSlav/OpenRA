BuildBase = function()
	...
	if not CheckForCYard then return 
...
SendShips = function()
	Utils.Do(Ships, function(ship) ship.AttackMove(waypoint77.Location) end)
	Utils.Do(Ships, function(ship) ship.AttackMove(waypoint14.Location) end)
	Utils.Do(Ships, function(ship) ship.AttackMove(waypoint51.Location) end)
	Utils.Do(Ships, function(ship) ship.Hunt() end)
end

SendInfantry = function()
	Utils.Do(GreeceInfAttack, function(inf) inf.AttackMove(waypoint2.Location) end)
	Utils.Do(GreeceInfAttack, function(inf) inf.AttackMove(waypoint48.Location) end)
	Utils.Do(GreeceInfAttack, function(inf) inf.AttackMove(waypoint49.Location) end)
	Utils.Do(GreeceInfAttack, function(inf) inf.AttackMove(waypoint1.Location) end)
	Utils.Do(GreeceInfAttack, function(inf) inf.Hunt() end)
end
...
SendInfantryGG = function()
	Utils.Do(GGInfAttack, function(inf) inf.AttackMove(waypoint29.Location) end)
	Utils.Do(GGInfAttack, function(inf) inf.AttackMove(waypoint30.Location) end)
	Utils.Do(GGInfAttack, function(inf) inf.AttackMove(waypoint40.Location) end)
	Utils.Do(GGInfAttack, function(inf) inf.Hunt() end)
end
...
SendTanksGG = function()
	Utils.Do(TankAttackGG, function(tnk) tnk.AttackMove(waypoint29.Location) end)
	Utils.Do(TankAttackGG, function(tnk) tnk.AttackMove(waypoint30.Location) end)
	Utils.Do(TankAttackGG, function(tnk) tnk.AttackMove(waypoint40.Location) end)
	Utils.Do(TankAttackGG, function(tnk) tnk.Hunt() end)
end